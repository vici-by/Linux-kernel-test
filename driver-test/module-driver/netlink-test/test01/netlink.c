...
static struct netlink_kernel_cfg gidd_nlcfg = {
    .groups = 0,  //1 means group broadcast 0 means unicast
    .input = nl_data_ready,
};
...
{
    nl_sk = netlink_kernel_create(&init_net, NETLINK_TEST,&gidd_nlcfg);
    if(!nl_sk){
